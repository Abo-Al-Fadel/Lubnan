...
namespace Lubnan.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260820165125_Avatars")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lubnan.Domain.Users.Avatar", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("UserId")
                        .IsUnique()
                        .HasDatabaseName("ix_user_avatars_user");
            ...
            modelBuilder.Entity("Lubnan.Domain.Users.Avatar", b =>
                {
                    b.HasOne("Lubnan.Domain.Users.User", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_user_avatars_user_id");
                });
